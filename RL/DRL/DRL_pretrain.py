...
class DRLPretrain(object):
    ...
    def __call__(self, cluster, clock, temperature=1, rent_or_not=False):
        ...
        target_machine = all_candidates[ground_true][0]
        target_task = all_candidates[ground_true][1]
        # print('machine:{}, task:{}, clock:{}, rankScore: {}'.format(target_machine.id, target_task.task_index, clock, self.rankScore))
