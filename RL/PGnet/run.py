...
model_path = os.getcwd()+'/RL/model/{}'.format('PGnetV2')

# 要注意如果机器的cpu或者memory不够，就永远不会训练结束
machine_config = [MachineConfig(8, 1024, 1) for i in range(machine_num)]
...
def read_data():
    ...
    for t in task_type:
        for i in range(10):
            job_data = '{}\\RL\\csv\\{}_{}_{}.csv'.format(os.getcwd(), t, task_num, i)
